...
SMART_ACTIONS = [
    ACTION_ID_DO_NOTHING,
    ACTION_ID_TRAIN_SCV,
    ACTION_ID_TRAIN_MARINE,
    ACTION_ID_TRAIN_BATTLE_CRUISER,
    ACTION_ID_BUILD_SUPPLY_DEPOT,
    ACTION_ID_BUILD_BARRACKS,
    ACTION_ID_BUILD_MISSILE_TURRET,
    ACTION_ID_BUILD_ENGINEERING_BAY,
    ACTION_ID_BUILD_REFINERY,
    ACTION_ID_BUILD_FACTORY,
    ACTION_ID_BUILD_STARPORT,
    ACTION_ID_BUILD_FUSION_CORE,
    ACTION_ID_UPGRADE_STARPORT_TECHLAB,
    ACTION_ID_ECONOMISE,
    ACTION_ID_SCV_TO_VESPENE,
    ACTION_ID_SCV_INACTIV_TO_MINE,
    ACTION_ID_DEFEND_POSITION,
    ACTION_ID_DEFEND_VS_ENEMY,
    ACTION_ID_ATTACK,
    ACTION_ID_SUPPLY_DEPOT_RAISE_QUICK
]
